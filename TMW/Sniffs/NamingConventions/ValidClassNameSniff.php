 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class TMW_Sniffs_NamingConventions_ValidClassNameSniff implements PHP_CodeSniffer_Sniff
{
    ...
    public function process(PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        if (preg_match('|^[\p{L}]|', $name) === 0) {
            $error = '%s name must begin with a letter';
            $phpcsFile->addError($error, $stackPtr, 'StartWithLetter', $errorData);
        }
